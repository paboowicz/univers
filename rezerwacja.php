	...
	<div class="centerContainer" style="position: relative;">
		...
		<div class="contentBox">
		    ...
		    <h1>Rezerwacja</h1>
			    ...
			    <? include('mailsupport.php'); ?>
			    <form id="booking" method="POST">
				<p>imie i nazwisko</p>
				<input type="text" class="fullWidth" name="name_surname" />
				<p>telefon konktaktowy</p>
				<input type="text" class="fullWidth" name="phone" />
				<p>adres email</p>
				<input type="text" class="fullWidth" name="email" />
				<p>wiadomość</p>
				<textarea style="min-height: 200px;" class="fullWidth" name="msg" ></textarea>
				<br/>
				<br/>
